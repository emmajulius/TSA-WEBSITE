...
const About = () => {
  ...
  const milestones = [
    ...
    { year: '2020', title: 'Cloud Expansion', description: 'Expanded services to include cloud solutions and DevOps' },
      ...
      <div className="about-container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            ...
            into successful digital solutions. With over a decade of experience, we've helped 
